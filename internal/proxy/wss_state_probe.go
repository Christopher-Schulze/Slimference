...
func (p WSSProbe) ProbeWSS(_ context.Context) control.WSSState {
	...
	state := control.WSSState{
		...
		CompressedMessagesInspected:  snap.WSMITMCompressedInspected,
		CompressedMessagesMutated:    snap.WSMITMCompressedMutated,
		CompressedMessagesBypassed:   snap.WSMITMCompressedBypassed,
		CompressionErrors:            snap.WSMITMCompressionErrors,
		PhaseFRequests:               snap.WSMITMPhaseFRequests,
		PhaseFRequestBodies:          snap.WSMITMPhaseFRequestBodies,
		PhaseFRequestMessagesIndexed: snap.WSMITMPhaseFIndexed,
