...
func productStatusFromSetupState(state control.SetupState) tui.ProductStatus {
	...
	return tui.ProductStatus{
		...
		ToolPruneTokensSaved:       product.ToolPruneTokensSaved,
		ToolPrunePrunedTools:       product.ToolPrunePrunedTools,
		ToolPruneReattached:        product.ToolPruneReattached,
		ToolPruneMisses:            product.ToolPruneMisses,
		ToolPruneRetries:           product.ToolPruneRetries,
		OutputReduceInjectedTurns:  product.OutputReduceInjectedTurns,
		OutputReduceObservedTokens: product.OutputReduceObservedTokens,
		OutputReduceInputOverhead:  product.OutputReduceInputOverhead,
