...
go run ./scripts/utils wss-audit ~/.slimference/debug/decisions.jsonl --json         # content-free WSS route/session/request-shape/full-history-cost/re-read/history-reducer/shadow-mirror density audit
