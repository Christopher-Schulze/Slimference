...
go run ./scripts/utils wss-audit ~/.slimference/debug/decisions.jsonl --json         # content-free WSS route/session/observed+resolved-shape/full-history-cost/re-read/history-reducer/shadow-mirror density audit
