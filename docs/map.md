...
- `internal/contextledger/message_apply.go`: exact full-history message/block apply primitive with archive byte-match, selected-target token accounting, and full-pass gates for unsafe targets
