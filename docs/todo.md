...
- [ ] T143 - Layer 1 semantic deterministic compaction frontier: push local/no-third-party compression beyond minify/dedup into tokenizer-aware budgeting, reversible dictionaries, language symbol slicing, stacktrace/test-failure semantics, config/schema compaction, and Markdown/SQL/framework-aware structure reduction with strict negative-savings and fidelity gates. Detail: `docs/todo/t143-l1-semantic-deterministic-frontier.md`
...
- [ ] T147 - Layer 0 real-traffic parser frontier: extend parser coverage by actual high-volume tool outputs and ecosystems, not random language lists: Go/Rust/TS/JS/Bun/Node/Python/React/Svelte/Zig/C/C++/SQL/DB/Java/Kotlin/Swift/PHP/Docker/Kubernetes/Terraform and monorepo tools. Detail: `docs/todo/t147-l0-parser-frontier-real-traffic.md`
