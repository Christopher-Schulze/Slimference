...
- [ ] T147 - Layer 0 real-traffic parser frontier: frontend, Python, and SQL/DB diagnostic slices landed through the shared diagnostic model. Covered locally: Next/Vite/Vitest/Jest/Playwright/ESLint/Biome/Oxlint/Turbo/Bun, ruff/pylint/flake8/mypy/pyright/pytest/unittest matching, and psql/sqlite/mysql/mariadb/Prisma/Drizzle/SQLFluff/Sqruff matching including common package-manager wrappers. Remaining: package install/resolver errors, rich DB table/explain output, JVM/mobile stacks, Docker/Kubernetes, monorepo logs, and parser telemetry. Detail: `docs/todo/t147-l0-parser-frontier-real-traffic.md`
