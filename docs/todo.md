...
- [ ] T147 - Layer 0 real-traffic parser frontier: first frontend diagnostic slice landed for Next/Vite/Vitest/Jest/Playwright/ESLint/Biome/Oxlint/Turbo/Bun through the shared diagnostic model. Remaining: deeper real-traffic parsers for Python, package managers, DB clients, JVM/mobile stacks, Docker/Kubernetes, monorepo logs, and parser telemetry. Detail: `docs/todo/t147-l0-parser-frontier-real-traffic.md`
