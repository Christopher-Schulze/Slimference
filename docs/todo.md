...
Layer 2 is removed from the product. Old task detail files may remain as
historical records, but they do not define current work and must not be used to
reintroduce MiniMax, summarization, OCRL, or context-ledger insertion.

## Active

- [~] T280 Final post-removal proof refresh -> docs/todo/t280-final-post-removal-proof-refresh.md
...
- [x] T263 Layer 3 provider/cache max-out -> docs/todo/t263-layer3-provider-cache-maxx.md
...
- Active product layers: Layer 0, Layer 1, Layer 3, Layer 4.
- Removed product layer: Layer 2.
