...
- [ ] T147 - Layer 0 real-traffic parser frontier: frontend diagnostic slice and Python diagnostic slice landed through the shared diagnostic model. Covered locally: Next/Vite/Vitest/Jest/Playwright/ESLint/Biome/Oxlint/Turbo/Bun plus ruff/pylint/flake8/mypy/pyright/pytest/unittest matching. Remaining: package managers, DB clients, JVM/mobile stacks, Docker/Kubernetes, monorepo logs, and parser telemetry. Detail: `docs/todo/t147-l0-parser-frontier-real-traffic.md`
