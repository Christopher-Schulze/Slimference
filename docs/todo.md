...
- [~] **T248** Unified Codex savings engine for WSS and HTTP — new P0 owner
  ...
  variants, measured L2/L3 upgrades, standalone A/B report mode, and broader real
...
- [~] **T249** Codex comprehension safety net — foundation gate for all aggressive
  ...
  reducer replay, default-off archive recovery note, and re-read-after-collapse
  auto-restore are implemented; standalone report mode and live socket
  measurement remain open. No direct savings; unlocks t253/t254/t255 to be
  enabled with data instead of hope.
...
| 11 | Comprehension A/B harness | enabler | Enabler | T249 | PARTIAL (core engine + WSS reducer replay landed; report/live replay pending) |
